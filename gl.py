...
class Render(object):
	...
	def shader(self, x, y):
		...
		xLevel = x/self.width
		if(bloque%10 == 0):
			return glColor(0,int(200*xLevel),40)
		if(bloque%10 == 1):
			return glColor(0,int(180*xLevel),30)
		if(bloque%10 == 2):
			return glColor(0,int(160*xLevel),20)
		if(bloque%10 == 3):
			return glColor(0,int(140*xLevel),10)
		if(bloque%10 == 4):
			return glColor(0,int(120*xLevel),0)
		if(bloque%10 == 5):
			return glColor(0,int(100*xLevel),10)
		if(bloque%10 == 6):
			return glColor(0,int(120*xLevel),20)
		if(bloque%10 == 7):
			return glColor(0,int(140*xLevel),30)
		if(bloque%10 == 8):
			return glColor(0,int(160*xLevel),40)
		if(bloque%10 == 9):
			return glColor(0,int(180*xLevel),50)	
